$(document).ready(function() {
	...
	$(".link_area .tab_list li").on("mouseenter",function(){
		if(!$(this).hasClass("current")){
			...
			$("http://www.tencent.com/js/.link_area .con").hide();
	...
	function develop_area_banner(l){
		...
		$('http://www.tencent.com/js/.develop_area .slide-tab .li').removeClass('active');
		$('http://www.tencent.com/js/.develop_area .slide-tab .li').eq(develop_area_index).addClass('active');
	}
	var develop_area_banner_time = setInterval(develop_area_banner,5000);

	$('http://www.tencent.com/js/.develop_area .slide-tab .li').on('click',function(){
	...
	setTimeout(function(){
		...
		$('.mod-tab li').on('click',function(){
			...
			$('http://www.tencent.com/js/.mod-tab .line').stop().animate({'left':$(this).position().left+'px','width': $(this).width()},200);
	...
	function scrollNav(dom){
		...
		sections.each(function(index,el){
			...
			if( _this.offset().top <=  $(document).scrollTop()){
				$('http://www.tencent.com/js/.mod-tab .line').stop().animate({'left':$('.mod-tab li').eq(index).position().left+'px','width': $('.mod-tab li').eq(index).width()},200);
				$('.mod-tab li').removeClass('active-tab');
