...
;(function(IPAY, INFO, LIB, $) {
    ...
    $('#changeUin').hide();
})(IPAY, INFO, LIB, jQuery);;(function(ABTest,IPAY){var platform=IPAY.getParam('p');if(platform==='15998'){$('#changeUin').hide();$('#ext_actions').hide();}})(ABTest,IPAY);/*  |xGv00|13f81e9a76ca455479c0086f65d160b2 */