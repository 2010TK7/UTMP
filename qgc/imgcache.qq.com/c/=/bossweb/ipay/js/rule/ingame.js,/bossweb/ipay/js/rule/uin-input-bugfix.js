...
;(function(IPAY, INFO, LIB, $) {
    ...
    $('#changeUin').hide();
})(IPAY, INFO, LIB, jQuery);;(function(ABTest,IPAY){if(IPAY.getParam('p')==='15998'){ABTest.after(IPAY,'_setTargetUinInputEditable',function(editable){editable&&setTimeout(function(){$('#target_uin_input').hide().show();},1);});}})(ABTest,IPAY);/*  |xGv00|5feb030d215a5909c82f41ff71615599 */