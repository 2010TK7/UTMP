...
(function(TOOL){
    ...
    TOOL.getExt = function(holder,url,callBack,errorCallBack) {
        if(holder){
            holder.html('<div class="imc_tenpay_con1"><div class="aw_table"><p style="margin-top: 0px;"><img src="../../images/img_loading.gif"/*tpa=https://kf.qq.com/images/img_loading.gif*//>查询中，请稍候...</p></div></div>');
        }
        var _callBack = function(){
            ...
            if(res.resultcode == 101){
                ...
                window.location.href = 'http://admin.cm.com/cgi-bin/start?GroupID=295&DirectPage=' + encodeURIComponent(url[0] + '?check=1');
                if(holder){
                    holder.html('<div class="imc_tenpay_con1"><div class="aw_table"><p style="margin-top: 0px;"><img src="../../images/bg_tishi1.gif"/*tpa=https://kf.qq.com/images/bg_tishi1.gif*//>会话过期，请重新登录</p></div></div>');
                }
            }else if(holder && res.resultcode == -104){
                holder.html('<div class="imc_tenpay_con1"><div class="aw_table"><p style="margin-top: 0px;"><img src="../../images/bg_tishi1.gif"/*tpa=https://kf.qq.com/images/bg_tishi1.gif*//>访问权限不足，请联系主管申请</p></div></div>');
            }else if(holder && res.resultcode != 0){
                holder.html('<div class="imc_tenpay_con1"><div class="aw_table"><p style="margin-top: 0px;"><img src="../../images/bg_tishi1.gif"/*tpa=https://kf.qq.com/images/bg_tishi1.gif*//>查询结果返回异常</p></div></div>');
            }else{
