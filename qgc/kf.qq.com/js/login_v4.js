...
document.domain="https://kf.qq.com/js/qq.com";
...
{
	if(backUrl.indexOf("https://kf.qq.com/js/kf.qq.com") < 0)
	{
...
function addHeadCookie(objName, objValue, objHours){
    ...
    str += "https://kf.qq.com/js/;domain=kf.qq.com";
    if (objHours > 0) {
        var date = new Date();
...
function showGameLoginTitle_cb(obj,paras)
{
	...
	if (is_login == "1")
	{
		...
		{
			document.getElementById("game_link").innerHTML = "欢迎您（" + HtmlAttributeEncode(nick_name) + "），<a href='javascript:doLogout()' style='text-decoration:underline;'>退出</a>| <a href='"+gameIndexPage+"' target='_blank' style='text-decoration: underline;'>游戏官网</a> | <a href='../index.htm'/*tpa=http://kf.qq.com/*/ target='_blank' style='text-decoration: underline;'>腾讯客服</a> | <a href='"+gameServicePage+"' style='text-decoration: underline;'>客服专区</a>";
		}
	}
	else 
	{
		if(document.getElementById('game_link')!=undefined)
		{
			document.getElementById("game_link").innerHTML = "欢迎您来到腾讯客服中心,<a href=\"javascript:openLogin('"+loginUrl+"')\" style='text-decoration:underline;'>登录</a>| <a href='"+gameIndexPage+"' target='_blank' style='text-decoration: underline;'>游戏官网</a> | <a href='../index.htm'/*tpa=http://kf.qq.com/*/ target='_blank' style='text-decoration: underline;'>腾讯客服</a> | <a href='"+gameServicePage+"' style='text-decoration: underline;'>客服专区</a>";
		}
	}
}
...
function showAloneLoginTitle_cb(obj,paras)
{
	...
	if (is_login == "1")
	{
		...
		{
			document.getElementById("alone_link").innerHTML = "欢迎您（" + HtmlAttributeEncode(nick_name) + "），<a href='javascript:doLogout()' style='text-decoration:underline;'>退出</a>| <a href='"+serviceIndexPage+"' style='text-decoration: underline;' target='_blank'>"+serviceName+"</a> | <a href='../index.htm'/*tpa=http://kf.qq.com/*/ target='_blank' style='text-decoration: underline;'>腾讯客服</a> | <a href='"+serviceFaqPage+"' style='text-decoration: underline;'>客服专区</a>";
		}
	}
	else 
	{
		if(document.getElementById('alone_link')!=undefined)
		{
			document.getElementById("alone_link").innerHTML = "欢迎您来到腾讯客服中心,<a href=\"javascript:openLogin('"+loginUrl+"')\" style='text-decoration:underline;'>登录</a>| <a href='"+serviceIndexPage+"' style='text-decoration: underline;' target='_blank'>"+serviceName+"</a> | <a href='../index.htm'/*tpa=http://kf.qq.com/*/ target='_blank' style='text-decoration: underline;'>腾讯客服</a> | <a href='"+serviceFaqPage+"' style='text-decoration: underline;'>客服专区</a>";
		}
	}
...
function showSpecialLoginTitle_cb(obj,paras)
{
	...
	else 
	{
		if(document.getElementById('special_link')!=undefined)
		{
			document.getElementById("special_link").innerHTML = "欢迎您来到腾讯客服中心,<a href=\"javascript:openLogin('"+loginUrl+"')\" style='text-decoration:underline;'>登录</a>| <a href='"+serviceIndexPage+"' style='text-decoration: underline;' target='_blank'>"+serviceName+"</a> | <a href='../index.htm'/*tpa=http://kf.qq.com/*/ target='_blank' style='text-decoration: underline;'>腾讯客服</a> | <a href='"+serviceFaqPage+"' style='text-decoration: underline;'>客服专区</a>";
		}
	}
}
...
function showQzoneLoginTitle_cb(obj,paras)
{
	...
	if (is_login == "1")
	{
		if(document.getElementById('special_link')!=undefined)
		{
			document.getElementById("special_link").innerHTML = "欢迎您（" + HtmlAttributeEncode(nick_name) + "），<a href='javascript:doLogout()' style='text-decoration:underline;'>退出</a>| <a href='#' style='text-decoration: underline;' onclick=\"window.open('"+serviceIndexPage+"', '_blank')\">"+serviceName+"</a> | <a href='../index.htm'/*tpa=http://kf.qq.com/*/ target='_blank' style='text-decoration: underline;'>腾讯客服</a> | <a href='"+serviceFaqPage+"' style='text-decoration: underline;'>客服专区</a>";
		}
	}
	else 
	{
		if(document.getElementById('special_link')!=undefined)
		{
			document.getElementById("special_link").innerHTML = "欢迎您来到腾讯客服中心,<a href=\"javascript:openLogin('"+loginUrl+"')\" style='text-decoration:underline;'>登录</a>| <a href='#' style='text-decoration: underline;' onclick=\"window.open('"+serviceIndexPage+"', '_blank')\">"+serviceName+"</a> | <a href='../index.htm'/*tpa=http://kf.qq.com/*/ target='_blank' style='text-decoration: underline;'>腾讯客服</a> | <a href='"+serviceFaqPage+"' style='text-decoration: underline;'>客服专区</a>";
		}
	}
}
// 登出
function doLogout()
{
	...
	if ( sURL.indexOf("AskForFillDatum") != -1 )
	...
	else if ( sURL.indexOf("https://kf.qq.com/js/index_login.html")!= -1 || sURL.indexOf("personalinfo.shtml")!= -1 || sURL.indexOf("personalcenter.shtml")!= -1)
		...
		//sURL = get_url_domain(sURL) + "/index.html";
		sURL = sURL;	
	window.location.href = "../cgi-bin/Logout-url=.htm"/*tpa=https://kf.qq.com/cgi-bin/Logout?url=*/ + encodeURIComponent(sURL) ;
}
...
function addFavorite()
{
	...
	{
    window.sidebar.addPanel("腾讯客服官方网站", "../index.htm"/*tpa=http://kf.qq.com/*/,"");
	}
	else if (document.all) 
	{
		window.external.addFavorite("../index.htm"/*tpa=http://kf.qq.com/*/, "腾讯客服官方网站");
	}
}
